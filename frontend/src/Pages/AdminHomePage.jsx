        ...
        <div className='max-w-7xl mx-auto p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                <div className="p-4 shadow-md rounded-lg">
                    ...
                    <p className='text-2xl'>${typeof totalSales === 'number' ? totalSales.toFixed(2) : "0.00"}</p>
                </div>
                            ...
                            {orders.length>0 ? (
                                orders.map((order)=>(
                                    <tr key={order._id} className='border-b hover:bg-gray-50 cursor-pointer'>
                                        ...
                                        <td className='p-4'>{order.user && order.user.name ? order.user.name : "Unknown"}</td>
                                        <td className='p-4'>{typeof order.totalPrice === 'number' ? order.totalPrice.toFixed(2) : "0.00"}</td>
