...
const OrderConfirmationPage = () => {
    ...
    //clear teh cart when the order is confirmed
    useEffect(()=>{
    ...
    const calculateEstimatedDelivery=(createdAt)=>{
        ...
        OrderDate.setDate(OrderDate.getDate()+10);  //Add 10days to the order Date
            ...
            {checkout && (
                <div className="p-6 rounded-lg border">
                    <div className='flex justify-between mb-20'> 
                        ...
                        {/* Estimated Delivery */}
                        <div>
                            <p className="text-sm text-emerald-700">Estimated Delivery:{" "} {calculateEstimatedDelivery(checkout.createdAt)}</p>
                        </div>
                    </div>
