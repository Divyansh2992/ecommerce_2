                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className="hidden md:flex flex-col space-y-4 mr-6">
                        {selectedProduct.images.map((image,index)=>(
                            <img key={index} src={image.url} alt={image.altText || `Thumbnail ${index}`} onClick={()=>setMainImage(image.url)} className={`w-20 h-20 object-cover rounded-lg cursor-pointer border ${mainImage===image.url ? "border-black": "border-gray-300"}`}/>
                        ))}
                    </div>
                    ...
                    <p className='text-lg text-gray-600 mb-1 line-through'>
                        ...
                        <div className='mb-4'>
                            ...
                            <div className='mb-4'>
                                ...
                                <div className='flex gap-2 mt-2'>
                                    {Array.isArray(selectedProduct.sizes) && selectedProduct.sizes.map((size) => (
