          ...
          {Array.isArray(newArrivals) && newArrivals.length > 0 ? (
            newArrivals.map((product) => (
              <div key={product._id} className='min-w-[100%] sm:min-w-[50%] lg:min-w-[30%] relative'>
                <img
                  src={Array.isArray(product.images) && product.images[0]?.url ? product.images[0].url : "https://via.placeholder.com/500x500?text=No+Image"}
                  alt={Array.isArray(product.images) && product.images[0]?.altText ? product.images[0].altText : product.name}
            ...
            <div className='w-full text-center text-gray-500 py-10'>No new arrivals found.</div>
          )}
        </div>
