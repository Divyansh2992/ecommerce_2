       ...
       <footer className='border-t py-12'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            <div>
                ...
                <form className='flex'>
                    <input type='email' placeholder='Enter your Email' className='p-3 w-full text-small border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'></input>
